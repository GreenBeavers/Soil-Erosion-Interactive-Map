...
UKCEH_LC_2021 <- rast("C:/Users/bs498/OneDrive - University of Exeter/GIS group project/Land Cover Map 2021/lcm-2021-10m_5473898/gblcm10m2021.tif")
...
main_database_WGS <- st_as_sf(main_database_WGS, coords = c("Easting", "Northing"), crs = 27700) 
...
st_write(Points_LC_Named, "C:/Users/bs498/OneDrive - University of Exeter/GIS group project/Project_C/Data/UK_LC_Grid_SoilErosion.gpkg")

...
LC_Grid <- st_read("C:/Users/bs498/OneDrive - University of Exeter/GIS Group Work/Project_C/Data/UK_LC_Grid_SoilErosion.gpkg")
...
Interpolated_Rainfall_Data <- read.csv("C:/Users/bs498/OneDrive - University of Exeter/GIS Group Work/Project_C/Data/Interpolation.csv")

#Read the UK DTM
#DTM <- raster("C:/Users/bs498/OneDrive - University of Exeter/GIS Group Work/Project_C/Data/Reprojected_Rasterized_DEM.tif")

#Extract elevation values from the DTM
elevation_values <- DTM_df$Reprojected_Rasterized_DEM

#Set up a colour scale based on elevation values
#pal_DTM <- colorNumeric(palette = "terrain.colors", domain = elevation_values)
